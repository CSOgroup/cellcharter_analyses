...
#from src.dlpfc.SEDR._utils import adata_preprocess, load_ST_file, graph_construction
        ...
        for gcn_hidden2 in gcn_hiddens2:
            for pc in pcs:
                ...
                for i in range(5):
                    ...
                    aris_df.to_csv(f"/work/FAC/FBM/DBC/gciriell/spacegene/Packages/cellcharter_analyses/results/dlpfc/SEDR/ARI_tuning_{sample}.csv")
