...
times_path = f"../../../results/benchmarking/time/time_CellCharter_hvgs{hvgs}_nlatent{n_latent}_nhoodlayers{nhood_layers}_{'gpu' if args.gpu else 'cpu'}_ncpus{args.n_cpus}.csv"
